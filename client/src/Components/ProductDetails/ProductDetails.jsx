...
const [ Quantity, setQuantity ] = useState(1)
  ...
  return (
    <div >
        ...
        <div className='border-primary border-solid h-auto mx-32 mt-20 border'>
          <p className='font-body ml-20 mt-10 text-ptext'>Product details</p>
          <div className=' font-body flex justify-between px-20 pt-10 pb-10'>
              <div>
                  <img src={shoe} alt="" width={400} className='mr-20' />
                  </div>
              ...
              <div>
                  ...
                  <p className='text-ptext mt-0'>Virgil Abloh's Off-White is a streetwear-inspired collection that continues to break away from the conventions of mainstream fashion. Made in Italy, these black and brown Odsy-1000 low-top sneakers.</p>
                  <div className='flex mb-0 bg-model'>
                    <p className='text-ptext pl-3 pr-10 text-sm '> Model: </p><p className='text-ptext  text-sm'>Adidas</p>
                  </div>
                  <div className='flex mt-3'>
                    <p className='text-ptext  pr-10 pl-3 text-sm mt-0 mb-0'> Color: </p><p className='text-ptext mb-0 mt-0 text-sm'>Brown</p>
                  </div>
                  <div className='flex mt-3 bg-model'>
                    <p className='text-ptext pl-3  pr-10 text-sm '> Delivery: </p><p className='text-ptext  text-sm'>Nation wide</p>
                  </div>
                  <div className='flex mt-6'>
                    <p className='text-ptext pr-24 text-sm'>Quantity</p> <p className='text-ptext text-sm'>Select Size</p>
                  </div>
                  <div className='flex'>
                    ...
                    <div className='mt-2'>
                      ...
                      <label for='size' className='text-ptext text-sm pr-10'>UK 9</label>
                      <input type="radio" name="size" className='cursor-pointer'  />
                      <label for='size' className='text-ptext text-sm pr-10'>UK 10</label>
                      <input type="radio" name="size" className='cursor-pointer'  />
                      <label for='size' className='text-ptext text-sm pr-10'>UK 11</label>
                    </div>
                  </div>
        ...
        <p className='font-body text-ptext ml-32'>Related Products</p>
          <div className='mt-20 mb-10 mx-40'>
