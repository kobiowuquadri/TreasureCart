        ...
        >
          ...
          <IoCartOutline  className='text-white text-xl'/>
            ...
            <div className='flex justify-center m-10 mx-80 max-[900px]:mx-0'>
                ...
                <input type="text" className=' mr-5 pl-14 container p-3 border-border border-solid border-2 outline-none font-body rounded ' placeholder='Search' 
               onChange={(e) => {
                  ...
                  .map((val) => (
                        <div className='m-2 bg-bck hover:shadow-2xl' key={val.id}>
                              ...
                              <div className=' p-2 '>
                                  ...
                                  <button className='container border-none bg-primary text-white font-body font-bold p-3 rounded hover:shadow-lg hover:opacity-80 cursor-pointer  '>ADD TO CART</button>
                              </div>
                        </div>
                  ))}
                </div>
